...
use CodeKandis\PhpUnit\Tests\DataProviders\Unit\Constraints\IsUnkeyedSubsetOfArrayConstraintTest\ConstraintClassNamesWithArrayAndStrictFlagDataProvider;
...
final class IsUnkeyedSubsetOfArrayConstraintTest extends TestCase
{
	 ...
	 * @param class-string<IsUnkeyedSubsetOfArrayConstraint> $constraintClassName The class name of the constraint to test.
