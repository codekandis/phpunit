...
use CodeKandis\PhpUnit\Tests\DataProviders\Unit\Constraints\AbstractArrayContainsSubsetConstraintTest\ConstraintClassNamesWithSubsetAndStrictFlagDataProvider;
...
final class AbstractArrayContainsSubsetConstraintTest extends TestCase
{
	 ...
	 * @param class-string<AbstractArrayContainsSubsetConstraint> $constraintClassName The class name of the constraint to test.
