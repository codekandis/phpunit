...
use CodeKandis\PhpUnit\Tests\DataProviders\Unit\Constraints\AbstractIsSubsetOfArrayConstraintTest\ConstraintClassNamesWithArrayAndStrictFlagDataProvider;
...
final class AbstractIsSubsetOfArrayConstraintTest extends TestCase
{
	 ...
	 * @param class-string<AbstractIsSubsetOfArrayConstraint> $constraintClassName The class name of the constraint to test.
