...
namespace CodeKandis\PhpUnit\Tests\Suites\Unit\Constraints\Helpers;

use CodeKandis\PhpUnit\Constraints\Helpers\ArraySubsetHelperInterface;
use CodeKandis\PhpUnit\DataProviderInterface;
use CodeKandis\PhpUnit\TestCase;
use CodeKandis\PhpUnit\Tests\DataProviders\Unit\Constraints\Helpers\ArraySubsetHelperInterfaceTest\ArraySubsetHelpersWithArraySubsetAndExpectedResultDataProvider;
...
final class ArraySubsetHelperInterfaceTest extends TestCase
{
	 ...
	 * @param array<array-key, mixed> $array The value to pass.
