 ...
 */
final readonly class ConstraintsWithMismatchingValueExpectedThrowableClassFqcnExpectedThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider0005 implements DataProviderInterface
{
	/**
	 * {@inheritDoc}
	 */
	...
	public static function provideData(): iterable
	{
		return [
			5000 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArray_16(), Values::BOOLEAN_FALSE ),
			...
			5038 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArray_16(), Values::BOOLEAN_TRUE ),
			...
			5107 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArray_17(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			5178 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArray_17(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			5249 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_26(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			5317 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_26(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			5386 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_27(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			5456 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_27(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			5526 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_28(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			5597 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_28(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
