 ...
 */
final readonly class ConstraintsWithMismatchingValueExpectedThrowableClassFqcnExpectedThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider0010 implements DataProviderInterface
{
	/**
	 * {@inheritDoc}
	 */
	...
	public static function provideData(): iterable
	{
		return [
			10000 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArraySubset_23(), Values::BOOLEAN_FALSE ),
			...
			10048 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArraySubset_23(), Values::BOOLEAN_TRUE ),
			...
			10120 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArraySubset_24(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			10190 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArraySubset_24(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			10262 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArraySubset_25(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			10333 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArraySubset_25(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			10405 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArray_16(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			10471 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArray_16(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			10540 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArray_17(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			10611 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArray_17(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			10682 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArraySubset_26(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			10748 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArraySubset_26(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			10817 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArraySubset_27(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			10887 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArraySubset_27(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			10957 => [
				'constraint'                 => $constraint = new ArrayContainsUnkeyedSubsetConstraint( Values::createArraySubset_28(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
