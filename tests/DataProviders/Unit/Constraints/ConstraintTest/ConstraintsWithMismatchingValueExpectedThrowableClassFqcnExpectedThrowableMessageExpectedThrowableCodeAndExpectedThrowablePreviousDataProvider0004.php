...
final readonly class ConstraintsWithMismatchingValueExpectedThrowableClassFqcnExpectedThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider0004 implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			4000 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArray_14(), Values::BOOLEAN_FALSE ),
			...
			4044 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArray_14(), Values::BOOLEAN_TRUE ),
			...
			4116 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArray_15(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			4186 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArray_15(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			4258 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_21(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			4328 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_21(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			4400 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_22(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			4470 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_22(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			4542 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_23(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			4613 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_23(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			4685 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_24(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			4755 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_24(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			4827 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_25(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			4898 => [
				'constraint'                 => $constraint = new ArrayContainsKeyedSubsetConstraint( Values::createArraySubset_25(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
