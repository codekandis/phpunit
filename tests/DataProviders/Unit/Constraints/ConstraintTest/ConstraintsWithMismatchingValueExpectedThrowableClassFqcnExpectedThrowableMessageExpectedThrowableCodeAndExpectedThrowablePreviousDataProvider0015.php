 ...
 */
final readonly class ConstraintsWithMismatchingValueExpectedThrowableClassFqcnExpectedThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider0015 implements DataProviderInterface
{
	/**
	 * {@inheritDoc}
	 */
	...
	public static function provideData(): iterable
	{
		return [
			...
			15165 => [
				'constraint'                 => $constraint = new IsKeyedSubsetOfArrayConstraint( Values::createArray_14(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			15220 => [
				'constraint'                 => $constraint = new IsKeyedSubsetOfArrayConstraint( Values::createArray_14(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			15282 => [
				'constraint'                 => $constraint = new IsKeyedSubsetOfArrayConstraint( Values::createArray_15(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			15349 => [
				'constraint'                 => $constraint = new IsKeyedSubsetOfArrayConstraint( Values::createArray_15(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			15418 => [
				'constraint'                 => $constraint = new IsKeyedSubsetOfArrayConstraint( Values::createArraySubset_21(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			15485 => [
				'constraint'                 => $constraint = new IsKeyedSubsetOfArrayConstraint( Values::createArraySubset_21(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			15553 => [
				'constraint'                 => $constraint = new IsKeyedSubsetOfArrayConstraint( Values::createArraySubset_22(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			15621 => [
				'constraint'                 => $constraint = new IsKeyedSubsetOfArrayConstraint( Values::createArraySubset_22(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			15690 => [
				'constraint'                 => $constraint = new IsKeyedSubsetOfArrayConstraint( Values::createArraySubset_23(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			15758 => [
				'constraint'                 => $constraint = new IsKeyedSubsetOfArrayConstraint( Values::createArraySubset_23(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			15827 => [
				'constraint'                 => $constraint = new IsKeyedSubsetOfArrayConstraint( Values::createArraySubset_24(), Values::BOOLEAN_FALSE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
			...
			15894 => [
				'constraint'                 => $constraint = new IsKeyedSubsetOfArrayConstraint( Values::createArraySubset_24(), Values::BOOLEAN_TRUE ),
				'mismatchingValue'           => $mismatchingValue = Values::NULL,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
				'expectedThrowableMessage'   => sprintf(
					'Failed asserting that %1$s%2$s.',
