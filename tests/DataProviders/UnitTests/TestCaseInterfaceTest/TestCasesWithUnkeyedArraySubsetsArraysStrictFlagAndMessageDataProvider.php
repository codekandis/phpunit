...
/**
 * Represents a data provider providing test cases with unkeyed array subsets, arrays, strict flag and message.
 * @package codekandis/phpunit
 * @author Christian Ramelow <info@codekandis.net>
 */
final readonly class TestCasesWithUnkeyedArraySubsetsArraysStrictFlagAndMessageDataProvider implements DataProviderInterface
{
	/**
	 * {@inheritDoc}
	 */
