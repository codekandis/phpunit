 ...
 */
final readonly class TestCasesWithExpectedSubsetActualArrayStrictMessageExpectedThrowableClassFqcnExpectedThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider0006 implements DataProviderInterface
{
	/**
	 * {@inheritDoc}
	 */
	...
	public static function provideData(): iterable
	{
		return [
			6000 => [
				...
				'expectedSubset'             => $expectedSubset = Values::createArray_15(),
			...
			6174 => [
				'testCase'                   => new TestCaseClassAccessor( Values::EMPTY_STRING ),
				'expectedSubset'             => $expectedSubset = Values::createArraySubset_21(),
			...
			6358 => [
				'testCase'                   => new TestCaseClassAccessor( Values::EMPTY_STRING ),
				'expectedSubset'             => $expectedSubset = Values::createArraySubset_22(),
				'actualArray'                => $actualArray = Values::ARRAY_0,
				'strict'                     => $strict = Values::BOOLEAN_FALSE,
				'message'                    => $message = Values::STRING_0,
				'expectedThrowableClassFqcn' => ExpectationFailedException::class,
