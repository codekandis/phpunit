 ...
 */
final readonly class TestCasesWithExpectedUnkeyedSubsetActualArrayStrictMessageExpectedThrowableClassFqcnExpectedThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider0006 implements DataProviderInterface
{
	/** {@inheritDoc} */
	#[Override]
	public static function provideData(): iterable
	{
		return [
			6000 => [
				...
				'expectedSubset'             => $expectedSubset = Values::createArraySubset_23(),
			...
			6154 => [
				'testCase'                   => new TestCaseClassAccessor( Values::EMPTY_STRING ),
				'expectedSubset'             => $expectedSubset = Values::createArraySubset_24(),
