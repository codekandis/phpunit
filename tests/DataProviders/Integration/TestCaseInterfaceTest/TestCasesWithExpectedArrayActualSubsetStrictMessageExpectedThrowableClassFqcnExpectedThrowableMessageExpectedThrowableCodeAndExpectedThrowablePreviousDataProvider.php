...
final readonly class TestCasesWithExpectedArrayActualSubsetStrictMessageExpectedThrowableClassFqcnExpectedThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			...
			...TestCasesWithExpectedArrayActualSubsetStrictMessageExpectedThrowableClassFqcnExpectedThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider0004::provideData(),
			...TestCasesWithExpectedArrayActualSubsetStrictMessageExpectedThrowableClassFqcnExpectedThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider0005::provideData(),
			...TestCasesWithExpectedArrayActualSubsetStrictMessageExpectedThrowableClassFqcnExpectedThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider0006::provideData(),
			...TestCasesWithExpectedArrayActualSubsetStrictMessageExpectedThrowableClassFqcnExpectedThrowableMessageExpectedThrowableCodeAndExpectedThrowablePreviousDataProvider0007::provideData()
		];
	}
}
