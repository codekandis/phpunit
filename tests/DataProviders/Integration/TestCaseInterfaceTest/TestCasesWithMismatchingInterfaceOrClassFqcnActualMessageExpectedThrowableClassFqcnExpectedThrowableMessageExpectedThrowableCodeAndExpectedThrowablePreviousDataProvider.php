...
/**
 * Represents a data provider providing test cases with mismatching interface or class FQCN, actual value, message, expected throwable FQCN, expected throwable message, expected throwable code and expected throwable previous.
	...
	public static function provideData(): iterable
	{
		return [
			0   => [
				...
				'expectedInterfaceOrClassFqcn' => $expectedInterfaceOrClassFqcn = Values::INTERFACE_FQCN,
			...
			36  => [
				'testCase'                     => new TestCaseClassAccessor( Values::EMPTY_STRING ),
				'expectedInterfaceOrClassFqcn' => $expectedInterfaceOrClassFqcn = Values::INTERFACE_FQCN,
				'actual'                       => $actual = Values::INTERFACE_FQCN,
				'message'                      => $message = Values::STRING_0,
				'expectedThrowableClassFqcn'   => ExpectationFailedException::class,
				'expectedThrowableMessage'     => static::buildExpectedThrowableMessage( $actual, $expectedInterfaceOrClassFqcn, $message ),
				'expectedThrowableCode'        => 0,
